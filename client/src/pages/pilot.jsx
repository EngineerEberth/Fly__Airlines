...
const Pilotos = () => {
    ...
    const fetchPilotos = async () => {
        try {
            const response = await axios.get('http://localhost:4000/api/pilotos', { withCredentials: true });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (editing) {
                await axios.put(`http://localhost:4000/api/pilotos/${formData._id}`, formData, { withCredentials: true });
            } else {
                await axios.post('http://localhost:4000/api/pilotos', formData, { withCredentials: true });
            }
            fetchPilotos();
    ...
    const handleDelete = async (id) => {
        try {
            await axios.delete(`http://localhost:4000/api/pilotos/${id}`, { withCredentials: true });
            fetchPilotos();
        } catch (error) {
