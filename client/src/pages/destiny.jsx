...
const Destinos = () => {
    ...
    const fetchDestinos = async () => {
        try {
            const response = await axios.get('http://localhost:4000/api/destinos', {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (editing) {
                // Actualizar destino
                await axios.put(`http://localhost:4000/api/destinos/${formData._id}`, formData, {
                    withCredentials: true,
                });
            } else {
                // Agregar nuevo destino
                await axios.post('http://localhost:4000/api/destinos', formData, {
                    withCredentials: true,
                });
            }
    ...
    const handleDelete = async (id) => {
        try {
            await axios.delete(`http://localhost:4000/api/destinos/${id}`, {
                withCredentials: true,
            });
